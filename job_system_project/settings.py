"""
Django settings for job_system_project project.
...
SECRET_KEY = 'django-insecure-dbqa9srzxonem%vmcsxw!f=&y*+3*^yel1#*pimfl&-n^y#pry'
...
WSGI_APPLICATION = 'job_system_project.wsgi.application'
